...
echo ==========================================
git branch -M main
echo Setting remote repository to https://github.com/EladioAMendez/teaching_dream...
git remote remove origin 2>nul
git remote add origin https://github.com/EladioAMendez/teaching_dream.git
...
if /i "%confirm%"=="Y" (
  echo Pushing to GitHub repository: https://github.com/EladioAMendez/teaching_dream
