...
const config = {
  // REQUIRED
  appName: "TeachingDream",
  // REQUIRED: a short description of your app for SEO tags (can be overwritten)
  appDescription:
    "Transform your FTCE prep from overwhelming to effortless with TeachingDream. Our AI-powered voice tutor helps you study smarter, not harder, so you can pass with confidence.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "teachingdream.com",
  crisp: {
  ...
  resend: {
    ...
    fromNoReply: `TeachingDream <noreply@teachingdream.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `The Team at TeachingDream <team@teachingdream.com>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "support@teachingdream.com",
  },
  colors: {
